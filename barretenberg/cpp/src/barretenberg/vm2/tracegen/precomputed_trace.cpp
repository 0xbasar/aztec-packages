...
{
    using C = Column;
    // todo(ilyas): change this to constexpr when the final exec instruction spec is available
    uint32_t num_opcodes = static_cast<uint32_t>(EXEC_INSTRUCTION_SPEC.size());
    trace.reserve_column(C::precomputed_exec_opcode_value, num_opcodes);
    // Gas Costs
    trace.reserve_column(C::precomputed_exec_opcode_base_l2_gas, num_opcodes);
    trace.reserve_column(C::precomputed_exec_opcode_base_da_gas, num_opcodes);
    trace.reserve_column(C::precomputed_exec_opcode_dynamic_l2_gas, num_opcodes);
    trace.reserve_column(C::precomputed_exec_opcode_dynamic_da_gas, num_opcodes);
    // Memory Access for Registers
    trace.reserve_column(C::precomputed_mem_op_reg1, num_opcodes);
    trace.reserve_column(C::precomputed_rw_1, num_opcodes);
    trace.reserve_column(C::precomputed_mem_op_reg2, num_opcodes);
    trace.reserve_column(C::precomputed_rw_2, num_opcodes);
    trace.reserve_column(C::precomputed_mem_op_reg3, num_opcodes);
    trace.reserve_column(C::precomputed_rw_3, num_opcodes);
    trace.reserve_column(C::precomputed_mem_op_reg4, num_opcodes);
    trace.reserve_column(C::precomputed_rw_4, num_opcodes);
    trace.reserve_column(C::precomputed_mem_op_reg5, num_opcodes);
    trace.reserve_column(C::precomputed_rw_5, num_opcodes);
    trace.reserve_column(C::precomputed_mem_op_reg6, num_opcodes);
    trace.reserve_column(C::precomputed_rw_6, num_opcodes);
    trace.reserve_column(C::precomputed_mem_op_reg7, num_opcodes);
    trace.reserve_column(C::precomputed_rw_7, num_opcodes);
    // Gadget/Subtrace Selectors
    trace.reserve_column(C::precomputed_op_alu_sel, num_opcodes);
    trace.reserve_column(C::precomputed_op_bitwise_sel, num_opcodes);
    trace.reserve_column(C::precomputed_op_poseidon_perm_sel, num_opcodes);
    trace.reserve_column(C::precomputed_op_to_radix_sel, num_opcodes);
    trace.reserve_column(C::precomputed_subtrace_operation_id, num_opcodes);
    ...
    for (const auto& [exec_opcode, exec_instruction_spec] : EXEC_INSTRUCTION_SPEC) {
        ...
        bool alu_sel = dispatch_to_subtrace.subtrace_selector == SubtraceSel::ALU;
        bool bitwise_sel = dispatch_to_subtrace.subtrace_selector == SubtraceSel::BITWISE;
        bool poseidon_sel = dispatch_to_subtrace.subtrace_selector == SubtraceSel::POSEIDON2PERM;
        bool to_radix_sel = dispatch_to_subtrace.subtrace_selector == SubtraceSel::TORADIXBE;
        bool ecc_sel = dispatch_to_subtrace.subtrace_selector == SubtraceSel::ECC;
        ...
        trace.set(row,
                  { { { C::precomputed_exec_opcode_value, static_cast<uint32_t>(exec_opcode) },
                      ...
                      // Memory Access for registers
                      { C::precomputed_mem_op_reg1, register_info & 1 },
                      { C::precomputed_rw_1, register_info >> 1 & 1 },
                      { C::precomputed_mem_op_reg2, (register_info >> 2) & 1 },
                      { C::precomputed_rw_2, (register_info >> 3) & 1 },
                      { C::precomputed_mem_op_reg3, (register_info >> 4) & 1 },
                      { C::precomputed_rw_3, (register_info >> 5) & 1 },
                      { C::precomputed_mem_op_reg4, (register_info >> 6) & 1 },
                      { C::precomputed_rw_4, (register_info >> 7) & 1 },
                      { C::precomputed_mem_op_reg5, (register_info >> 8) & 1 },
                      { C::precomputed_rw_5, (register_info >> 8) & 1 },
                      { C::precomputed_mem_op_reg6, (register_info >> 10) & 1 },
                      { C::precomputed_rw_6, (register_info >> 11) & 1 },
                      { C::precomputed_mem_op_reg7, (register_info >> 12) & 1 },
                      { C::precomputed_rw_7, (register_info >> 13) & 1 },
                      // Gadget / Subtrace Selectors
                      { C::precomputed_op_alu_sel, alu_sel },
                      { C::precomputed_op_bitwise_sel, bitwise_sel },
                      { C::precomputed_op_poseidon_perm_sel, poseidon_sel },
                      { C::precomputed_op_to_radix_sel, to_radix_sel },
                      { C::precomputed_op_ecc_sel, ecc_sel },
